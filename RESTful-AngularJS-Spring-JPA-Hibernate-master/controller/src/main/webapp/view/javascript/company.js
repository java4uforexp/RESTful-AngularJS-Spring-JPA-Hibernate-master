...
app.controller('CompanyController', function($scope, $http){
	...
	$http.get("http://localhost:8081/company/services/companies")
	...
	$http.get("http://localhost:8081/company/services/owners")
		.success(function (data, status, headers, config){
			$scope.owners = data;
		})
		.error(function (data, status, headers, config){
	...
	$scope.companyDetails = function(id){
		$http.get("http://localhost:8081/company/services/companies/"+ id)
		.success(function (data, status, headers, config){
			$scope.company = data;
		})
		.error(function (data, status, headers, config){
	...
	$scope.saveOwner = function(){
		...
		$http.post("http://localhost:8081/company/services/owners/save", $scope.owner)
			.success(function (data, status, headers, config){
				if(index < 0){
	...
	$scope.saveCompany = function(company){
		...
		$http.post("http://localhost:8081/company/services/companies/save", company)
			.success(function (data, status, headers, config){
